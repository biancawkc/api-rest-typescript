...
export class Default1685735435142 implements MigrationInterface {
    name = 'Default1685735435142'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "videos" ADD CONSTRAINT "FK_009df165edbdd06fa78e3bb1864" FOREIGN KEY ("room_id") REFERENCES "rooms"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
